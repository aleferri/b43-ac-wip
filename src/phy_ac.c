...
static void b43_phy_ac_txpwrctrl_setup(struct b43_wldev *dev, u16 freq)
{
	...
	for (core = 0; core < num_cores; core++) {
		 ...
		 * Provenienza (implementazione GPL indipendente):
...
static int b43_phy_ac_op_init(struct b43_wldev *dev)
{
	 ...
	 * La sequenza è replicata per fedeltà al vendor blob — se il HW 
	 * dovesse mostrare comportamenti anomali dopo bring-up,
	 * questi bit sono candidati da indagare.
	 *
