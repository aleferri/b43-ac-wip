...
Usage:
  ...
  reads.py intent <dir> [discarded-list]     list from test/unit/consumed_reads.sh
...
def main():
    ...
    p.add_argument("discarded", nargs="?",
                   help="output of test/unit/consumed_reads.sh, to restrict the "
